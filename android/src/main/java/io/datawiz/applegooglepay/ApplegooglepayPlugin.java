...
/**
 * ApplegooglepayPlugin
 */
public class ApplegooglepayPlugin implements MethodCallHandler, PluginRegistry.ActivityResultListener {
    ...
    public static void registerWith(Registrar registrar) {
        ...
        ApplegooglepayPlugin plugin = new ApplegooglepayPlugin(registrar.activity());
